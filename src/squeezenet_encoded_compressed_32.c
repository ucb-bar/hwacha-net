...
int main(int argc, char** argv)
{
...

  {
    ...
    fire2_conv3.type = fire3_conv3.type = fire4_conv3.type \
      = fire5_conv3.type = fire6_conv3.type = fire7_conv3.type \
      = fire8_conv3.type = fire9_conv3.type \
      = convfin.type = CONVOLUTIONAL_ENCODED_COMPRESSED;

    fire2_conv3.nids = 3040; fire2_conv3.nindptr = 65;
    fire3_conv3.nids = 3040; fire3_conv3.nindptr = 65;
    fire4_conv3.nids = 12157; fire4_conv3.nindptr = 129;
    fire5_conv3.nids = 12148; fire5_conv3.nindptr = 129;
    fire6_conv3.nids = 27326; fire6_conv3.nindptr = 193;
    fire7_conv3.nids = 27337; fire7_conv3.nindptr = 193;
    fire8_conv3.nids = 44145; fire8_conv3.nindptr = 257;
    fire9_conv3.nids = 44174; fire9_conv3.nindptr = 257;
    convfin.nids = 102324; convfin.nindptr = 1001;
...

  {
    ...
    //printf("%d %d %d\n", relufin.output_h, relufin.output_w, relufin.output_c);
  }
  ...
  {
    FILE* fp = fopen("weights/squeezenet_encoded_compressed_single.weights", "rb");
