...
int main(int argc, char** argv)
{
  ...
  // Load weights
  {
    ...
    input = safe_malloc(sizeof(int16_t) * max_io);
    output = safe_malloc(sizeof(int16_t) * max_io);
    workspace = safe_malloc(sizeof(int16_t) * max_ws);
    printf("%lu %lu\n", max_io, max_ws);
  ...
  /* layer teststart; */
  /* teststart.output_h = 4; */
  /* teststart.output_w = 6; */
  /* teststart.output_c = 1; */
  /* layer test; */
  /* test.type = MAXPOOL_DARKNET; */
  /* test.size = 2; */
  /* test.stride = 2; */
  /* test.pad = 0; */
  /* setup_layers(&teststart, &test); */
  /* printintmatrix(test.size * test.size * test.c, test.output_w, test.output_h, test.indices); */

  /* fill_seq_16(workspace, teststart.output_h*teststart.output_w*teststart.output_c, 1); */

  /* printint16matrix(teststart.output_c, teststart.output_w, teststart.output_h, workspace); */
  /* printint16matrix(test.output_c, test.output_w, test.output_h, input); */
  /* printf("%x\n", workspace); */
  /* layer_forward(&test, workspace, input, output); */
  /* printint16matrix(test.output_c, test.output_w, test.output_h, input); */
  /* return; */
  {
